    ...
    <div class="propslist_add">
        <div class="wrapper">
            ...
            <form action="/" method="post">
                ...
                <input class="input input-sm input-block" type="text" placeholder="Title">
                <input class="input input-sm input-block" type="text" placeholder="URL">
