...
<body>
      <main class="header theme-black">
        <div class="header-inner">
            <header class="m:header">
                <div class="wrapper js-hander">
                    <div class="header-line">
                        ...
                        <button class="btn btn-md btn-nav js-toggle-open">
                    ...
                    <nav class="mobile-nav">
                        <div class="header-line">
                            <a href="#0" class="btn btn-md btn-logo header-logo"><img src="http://yolllley.triplexlab.co.kr/src/imgs/logo-b.png" alt="로고"></a>
                            <button class="btn btn-md btn-nav js-toggle-clear">
            ...
            <header class="d:header js-hander">
                <div class="wrapper">
                    <div class="header-line">
                    <div class="nav-inner">
                        <a href="#0" class="btn btn-md btn-logo header-logo"><img src="http://yolllley.triplexlab.co.kr/src/imgs/logo-b.png" alt="로고"></a>
    ...
    <div class="experience_add">
        <div class="wrapper">   
            <h1 class="propslist-tit m:tit-xxl t:tit-xl d:tit-xxxl unna">
                Experience
            </h1>
            <form action="/" method="post">
                <div class="filebox">
                    <label for="file"><i class="material-icons">add</i></label> 
                    <input type="file" id="file" class="imageInput" name="myImage">
                </div>
                <input class="input input-sm input-block" type="text" placeholder="프로젝트 이름*">
                <div class="day-inner clearfix">
                    <div>
                        <input class="input input-sm input-block" type="text" placeholder="시작 일자*">
                    </div>
                    <div>
                        <input class="input input-sm input-block" type="text" placeholder="마무리 일자*">
                    </div>
                </div>
                <input class="input input-sm input-block" type="text" placeholder="태그 (Ex)#cafe/#Modern)*">

                <div class="filebox">
                    <label for="file"><i class="material-icons">add</i></label> 
                    <input type="file" id="file" class="imageInput" name="myImage">
                </div>
                <input class="input input-sm input-block" type="text" placeholder="제목*">
                <div class="textarea-txt__box">
                ...
                <div class="btn-inner clearfix">
                    ...
                    <div>
                        <button class="btn btn-b">Add</button>
                    </div>
                </div>
            </form>
        </div>
